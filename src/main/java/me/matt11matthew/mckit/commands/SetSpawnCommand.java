...
public class SetSpawnCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            String permission = duelConfig.getString("permissions.setSpawn");
            ...
            duelConfig.set("locations.spawnPoint", LocationUtil.getStringFromPlayerLocation(player.getLocation()));
            player.sendMessage(ChatColor.translateAlternateColorCodes('&', duelConfig.getString("messages.setSpawnPoint").replace("{location}", location)));
            return true;
        }
        return true;
    }
